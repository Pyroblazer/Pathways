 ...
 * Use the [CompanyDashboardFragment.newInstance] factory method to
...
class CompanyDashboardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment CompanyDashboardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CompanyDashboardFragment().apply {
